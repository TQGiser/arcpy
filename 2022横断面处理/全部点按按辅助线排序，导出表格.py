...
d = r'E:\2022年项目\0420许曲断面线\DMD2.shp'
Fzx = r'E:\2022年项目\0420许曲断面线\辅助线.shp'
cnList = []
with arcpy.da.SearchCursor(d,['SHAPE@','DMH','SHAPE@X','SHAPE@Y','SHAPE@Z']) as yb1:
    for row in yb1:
...
for name,group in df2:
    ...
    print name
    df3.to_csv(path.decode('utf') + '\\' + (r'{}.csv').format(name).decode('utf-8'),index=False)
