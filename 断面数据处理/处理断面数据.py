...
A = '多曲横断面测量成果表'.decode('utf-8')
path = r'D:\2021年项目\0727多曲修改断面数据\XLS\0728.xls'.decode('utf-8')
outpath = r'D:\2021年项目\0727多曲修改断面数据\xlsok'.decode('utf-8')
...
for name,group in df2:
    x0 = group[group['QD'] == '起点'.decode('utf-8')]['X'].values[0]
    y0 = group[group['QD'] == '起点'.decode('utf-8')]['Y'].values[0]
