        ...
        for row in yb:
            ...
            if a.split('泸定县段-')[0] in dem.encode('utf-8'):
                ...
                okdem = path3.decode('utf-8') + '\\' + a.decode('utf-8') + '\\' + demName.decode(
                    'utf-8')
                arcpy.Resample_management(ysdem, okdem, '2')                                                         #######重采样像元大小##############
